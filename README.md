> 현재 개발 앱: **햇살 드는 정원** 개편. 가입 없이 연령 확인·동의 후 로컬 사용, 오늘/기록, 무음 휴식, 수동 책상 안내, 집중 타이머.
> 현재 기준: [디자인 규칙](docs/DESIGN_SYSTEM_KO.md) · [제품 범위](docs/product/GARDEN_SCOPE_KO.md) · [DB v6 결정](docs/adr/0005-local-garden-experience.md).
> 아래 이전 제품/플랫폼 로드맵은 현재 제공 기능과 구분한다.
# Dopa
